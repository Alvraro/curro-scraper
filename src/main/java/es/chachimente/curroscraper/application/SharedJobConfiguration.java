				...
				.fieldExtractor(new FieldExtractor<CompanyInfo>() {
					...
					public Object[] extract(CompanyInfo item) {
						return new Object[] {
								...
								item.malditasConsultorasInfo() != null ? item.malditasConsultorasInfo().malditasConsultorasURL() : null,
								item.malditasConsultorasInfo() != null ? item.malditasConsultorasInfo().externalURL() : null,
								...
								item.glassdoorInfo() != null ? item.glassdoorInfo().glassdoorURL() : null, 
								item.glassdoorInfo() != null ? item.glassdoorInfo().externalURL() : null,
